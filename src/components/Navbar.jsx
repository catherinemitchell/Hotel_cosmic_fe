  ...
  return (
    ...
    <nav className="navbar" style={{ fontSize: 25 }}>
      ...
      <ul>
        ...
        <li className="active"><a href="/services" className="nav-link"> Services </a></li>
        <li className="active"><a href="/gallery" className="nav-link"> Gallery </a></li>
        <li className="active-icon">
        <a href="/reservations/search"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg></a>
        </li>
        </>
        }
        ...
        {(location.pathname === "/aboutus" || location.pathname === "/moonthemeroom" || location.pathname === "/jupiterthemeroom" || location.pathname === "/jupiterthemeroom" || location.pathname === "/reservations/search") && 
        <>
        <li className="active"><a href="/roomdisplay" className="nav-link"> Rooms </a></li>
        <li className="active"><a href="/lobby" className="nav-link"> Lobby </a></li>
        <li className="active"><a href="/services" className="nav-link"> Services </a></li>
